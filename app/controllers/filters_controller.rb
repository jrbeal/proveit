class FiltersController < ApplicationController
  ...
  private
    ...
    def filter_params
      params.require(:filter).permit(:name, :contested_opinions, :uncontested_opinions, :contested_objections, :uncontested_objections, :comments, :initiators, :following, :active, :bookmarks, :hot_topics, :categories, :key_words, :levels, :range, :today, :last_week, :last_month)
    end
end
